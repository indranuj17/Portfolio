        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0'>
          <div className='shadow-md shadow-gray-500 rounded-xl'>
            ...
            <div className='flex justify-center items-center'>
              <button className='px-5 py-2 m-3 w-1/2 font-bold text-xl duration-200 hover:scale-105  '>Demo</button>
              <button className='px-5 py-2 m-3 w-1/2 font-bold text-xl duration-200 hover:scale-105  '>Code</button>
            </div>
          </div>
